...
namespace QuanLyNhanSu.Category
{
    public partial class frmDepartment : Form
    {
        ...
        private void Search()
        {
            try
            {
                string contentUnit = Common.ReadFileContent(QLNSCommon.pathCategory + fileNameUnit);
                ...
                //             join item2 in unitRole on item1.UnitId equals item2.Id into joined
        ...
        private void Resize()
        {
            try
            {
                ...
                dataGridView1.Columns["Code"].HeaderText = "Mã đơn vị trực thuộc";
                dataGridView1.Columns["DepName"].HeaderText = "Tên đơn vị trực thuộc";
