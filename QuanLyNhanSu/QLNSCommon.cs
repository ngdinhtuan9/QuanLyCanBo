...
namespace QuanLyNhanSu
{
    public class QLNSCommon
    {
        ...
        public static string pathTrainee = AppDomain.CurrentDomain.BaseDirectory + "Data\\";
        public static string path = AppDomain.CurrentDomain.BaseDirectory;
        public static string glbVersion = "1.0.1";
        public static string glbContact = "0912899900";
        public static string glbImage = "";
        ...
        public static List<string> SplitStringByDelimiter(string input)
        {
            // Split the input string using the delimiter and convert the result to a list
